...
import UrlMappedToSwiftCloud from "./UrlMappedToSwiftCloud";
    ...
    <>
      <div className="row g-0">
        <div className="col" id="addressbook">
          ...
          {/* Website (work) */}
          <WebsiteWork  Dropdown={Dropdown}
            DropdownButton={DropdownButton}
            Icons={Icons}
            FontAwesomeIcon={FontAwesomeIcon}/>

          {/* URL Mapped to SwiftCloud */}
          <UrlMappedToSwiftCloud  Dropdown={Dropdown}
            DropdownButton={DropdownButton}
            Icons={Icons}
            FontAwesomeIcon={FontAwesomeIcon}/>

          {/* Add New */}
          <AddNew  Dropdown={Dropdown}
            DropdownButton={DropdownButton}
            Icons={Icons}
            FontAwesomeIcon={FontAwesomeIcon}/>
        </div>
