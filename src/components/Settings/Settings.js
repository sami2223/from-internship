                                        ...
                                        <div className="col-lg-12">
                                            <div className="row editable align-items-center">
                                                ...
                                                <div className="col-2 text-end">
                                                    <span onClick={() => { if (!openTeamAdmin) setOpenTeamAdmin(true); else { setOpenTeamAdmin(false); setOpenAddRole(false) }; }} className="round-edit-icon">
                                                        <i className={!openTeamAdmin ? "fa fa-pencil" : "fa fa-close"}></i>
                                                    </span>
                                                </div>
                                            </div>
                                            <div className={`row expand-content ${!openTeamAdmin ? "display-none" : ""}`}>
                                                <div className="col-lg-12">
                                                    <div className="row">
                                                        <div className={`col-lg-6 col-md-8 mx-auto py-4 ${!openAddRole ? "display-none" : ""}`}
                                                                                ...
                                                                                <div className="col-sm-12">
                                                                                    ...
                                                                                    <div className="row">
                                                                                        <div className="col-sm-12 text-end">
                                                                                            <button onClick={() => setOpenAddRole(false)} type="button" name="btnCancel" id="btnCancelUserAdmin"
                                                                        ...
                                                                        <div className="row">
                                                                            <div className="col-lg-12">
                                                                                ...
                                                                                <div className="float-end">
                                                                                    <button onClick={() => { setOpenAddRole(true); }}
                                                                                        type="button"
                                                                                        className="btn btn-primary"
                                    ...
                                    <div className="row g-0 block-content border-bottom">
                                        <div className="col-lg-12">
                                            <div className="row editable align-items-center">
                                                ...
                                                <div className="col-2 text-end">
                                                <span onClick={() => { if (!openTeamAdmin) setOpenLeadScoring(true); else { setOpenLeadScoring(false); setAddLeadScoring(false) }; }} className="round-edit-icon">
                                                        <i className={!openTeamAdmin ? "fa fa-pencil" : "fa fa-close"}></i>
                                                    </span>
                                                </div>
                                            </div>
