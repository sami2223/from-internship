...
const Settings = () => {
  ...
  const [openLeadScoring, setOpenLeadScoring] = useState(false);
  const [addLeadScoring, setAddLeadScoring] = useState(false);
        ...
        <div className="col-lg-12 generalSettings">
          <div className="accordion" id="SwiftfCloudSettings">
            <div className="accordion-item">
              ...
              >
                <FontAwesomeIcon icon={Icons.faBriefcase} className="me-2"/> About Your Business
              </h2>
              <div
                id="generalSettings"
                    ...
                    <div className="col-lg-12">
                      <div className="row editable align-items-center">
                        ...
                        <div className="col-2 text-end">
                          <span
                            onClick={() => {
                              if (!openTeamAdmin) setOpenTeamAdmin(true);
                              else {
                                setOpenTeamAdmin(false);
                          ...
                          >
                            {/* <i
                              className={
                                !openTeamAdmin ? "fa fa-pencil" : "fa fa-close"
                              }
                            ></i> */}
                            {!openTeamAdmin ? <FontAwesomeIcon icon={Icons.faPencil}/> : <FontAwesomeIcon icon={Icons.faClose} />}
                          </span>
                        </div>
                      </div>
                      <div
                          ...
                          <div className="row">
                            ...
                            >
                              <div className="row">
                                <div className="col-lg-12 colHeading">
                                  <strong>
                                    <FontAwesomeIcon icon={Icons.faUserPlus} /> Add /
                    ...
                    <div className="col-lg-12">
                      <div className="row editable align-items-center">
                        ...
                        <div className="col-2 text-end">
                          <span
                            onClick={() => {
                              if (!openTeamAdmin) setOpenLeadScoring(true);
                              else {
                                setOpenLeadScoring(false);
                                setAddLeadScoring(false);
                              }
                            }}
                            className="round-edit-icon"
                          >
                          ...
                          <div className="mb-3 row">
                            <div className="col-md-12">
                              ...
                              <div className="row mb-2 align-items-center">
                                <div className="col-md-6">
                                  <h4 className="mb-0">
                                    <FontAwesomeIcon icon={Icons.faUser} /> Roles for
                                    Your Business
                                  </h4>
                                </div>
                                <div className="col-md-6 text-end">
                  ...
                  <div className="row block-content g-0 border-bottom">
                    <div className="col-lg-12">
                      <div className="row editable align-items-center">
                        <div className="col-10">
                          <h5 className="block-title">
                          <FontAwesomeIcon icon={faHandshake} /> Task /
                          ...
                          <div className="mb-3 row">
                            <div className="col-md-12">
                              <div className="row">
                                ...
                                >
                                  <div className="row">
                                    <div className="col-lg-12 colHeading">
                                      <strong>
                                        <FontAwesomeIcon icon={Icons.faAsterisk} /> Add
                                        Asset Type
                                      </strong>
                                    </div>
                                    <div className="col-lg-12 dh-block-body">
                              ...
                              <div className="row mb-2 align-items-center">
                                <div className="col-md-6">
                                  <h4 className="mb-0">
                                    <FontAwesomeIcon icon={Icons.faAsterisk} /> Custom
                                    Asset Types
                                  </h4>
                                </div>
                                <div className="col-md-6 text-end">
                                ...
                                >
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      <td>
                                        <a href="#" target="_blank">
                                        <FontAwesomeIcon icon={Icons.faHome} /> rental
                                          unit
                                        </a>
                                      </td>
                                      <td>
                  ...
                  <div className="row block-content g-0 border-bottom">
                    <div className="col-lg-12">
                      <div className="row editable align-items-center">
                        <div className="col-10">
                          <h5 className="block-title">
                          <FontAwesomeIcon icon={Icons.faPaintbrush} /> Branding &
                            Cosmetics
                          </h5>
                        </div>
                        <div className="col-2 text-end">
                  ...
                  <div className="row block-content g-0">
                    <div className="col-lg-12">
                      <div className="row editable align-items-center">
                        <div className="col-10">
                          <h5 className="block-title">
                            <FontAwesomeIcon icon={Icons.faCircleUser} /> Client
                            Portal
                          </h5>
                        </div>
                        <div className="col-2 text-end">
          ...
          <div className="accordion-item">
            ...
            >
              <FontAwesomeIcon icon={Icons.faSignIn} className="me-2" /> Accessing SwiftCloud
            </h2>
            <div
          ...
          <div className="accordion-item">
            ...
            >
              <FontAwesomeIcon icon={Icons.faGlobe} className="me-2" /> Language & Location
            </h2>
            <div
          ...
          <div className="accordion-item">
            ...
            >
              <FontAwesomeIcon icon={Icons.faLock} className="me-2" /> Privacy & Communication
            </h2>
            <div
                  ...
                  <div className="col-lg-12">
                    ...
                    <div className="row expand-content display-none">
                      <div className="col-lg-8 col-sm-12 col-md-12 col-xs-12 mx-auto">
                        ...
                        <p>
                        <FontAwesomeIcon icon={Icons.faEyeSlash} className="fa-lg" /> To set your
                          account to maximum privacy and automatically privatize
                          all info known about you, <a href="#">click here</a>.
                        </p>
                        <p>
                        <FontAwesomeIcon icon={Icons.faPowerOff} className="fa-lg" /> Note that
          ...
          <div className="accordion-item">
            ...
            >
              <FontAwesomeIcon icon={Icons.faDollar} className="me-2" /> Financial
            </h2>
          </div>
          <div className="accordion-item">
            <h2
            ...
            >
              <FontAwesomeIcon icon={Icons.faComments} className="me-2" /> Communication
            </h2>
            <div
              id="commnication"
              className="accordion-collapse collapse"
          ...
          <div className="accordion-item">
            ...
            >
              <FontAwesomeIcon icon={Icons.faBullseye} className="me-2" /> On My Radar
            </h2>
            <div
              id="myRadar"
              className="accordion-collapse collapse"
