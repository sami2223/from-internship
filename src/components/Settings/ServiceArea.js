...
const ServiceArea = ({Dropdown, DropdownButton, Icons, FontAwesomeIcon }) => {
  ...
  return (
    <div className="row adbook-user-other-info align-items-center py-3 border-bottom company_info_row">
      ...
      <div className="col-md-4 inputbox">
        <select name="company_serve" id="company_serve" className="form-select">
          <option defaultValue="">== Select ==</option>
          <option defaultValue="Local-Address">Local (From Address)</option>
          <option defaultValue="Local-Service">Local (Service Area)</option>
