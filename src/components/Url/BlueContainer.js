...
const BlueContainer = ({ Icons, FontAwesomeIcon }) => {
  const [isCheckedAdjContacts, setIsCheckedAdjContacts] = useState(true);
  const [isCheckedTagContent, setIsCheckedTagContent] = useState(false);
  const [isCheckedVisitorFunnelStatus, setIsCheckedVisitorFunnelStatus] =
    useState(false);
  const [isCheckedURLvarSticky, setIsCheckedURLvarSticky] = useState(false);
  const [isCheckedAdditionalVar, setIsCheckedAdditionalVar] = useState(false);
  const [additionalVarForm, setAdditionalVarForm] = useState(1);
                ...
                <div className="dataInner">
                    ...
                    <div className="col-sm-12">
                      <div className="mb-0">
                        <input
                          ...
                          defaultValue="1"
                          checked={isCheckedAdjContacts}
                          onChange={() =>
                            setIsCheckedAdjContacts(!isCheckedAdjContacts)
                          }
                        />
                        <label
                  ...
                  <div className="row row-cols-lg-auto g-0 align-items-center mb-3 initialData">
                    <div className="col-12">
                      <input
                        ...
                        className="css-checkbox compressURLOn"
                        defaultValue="move"
                        checked={isCheckedVisitorFunnelStatus}
                        onChange={() =>
                          setIsCheckedVisitorFunnelStatus(
                            !isCheckedVisitorFunnelStatus
                          )
                        }
                      />
                      <label
                    ...
                    <div className="col-sm-12 googlTag">
                      <div className="mb-0">
                        <input
                          ...
                          checked={isCheckedTagContent}
                          onChange={() =>
                            setIsCheckedTagContent(!isCheckedTagContent)
                          }
                        />
                        <label
                          htmlFor="tagOpt"
                  ...
                  <div className="mb-3 row initialData extraForYouOpt g-0">
                    <div className="col-sm-12 additionalVars">
                        ...
                        <div className="col-lg-12">
                          <div className="mb-0">
                            <input
                              ...
                              checked={isCheckedAdditionalVar}
                              onChange={() =>
                                setIsCheckedAdditionalVar(
                                  !isCheckedAdditionalVar
                                )
                              }
                            />
                            <label
                      ...
                      {isCheckedAdditionalVar && (
                        <div className="row addAdditionalVarsContainer pt-3">
                          <div className="col-lg-12 used_variables_container">
                            {Array.from(
                              Array(Number(additionalVarForm)).keys()
                            ).map((item, index) => (
                              <div
                                key={index}
                                className="row row-cols-lg-auto g-2 align-items-center additionalVarsRow"
                              >
                                <div className="col-12">
                                  <input
                                    type="checkbox"
                                ...
                                <div className="col-12">
                                  {index === 0 ? (
                                    ...
                                    <>
                                      <a
                                        data-tip="Optional additional variables you </br> want to
                                  track"
                                  ...
                                  <a
                                    ...
                                    onClick={(e) => {
                                      e.preventDefault();
                                      setAdditionalVarForm(
                                        Number(additionalVarForm) - 1
                                      );
                                    }}
                    ...
                    <div className="col-sm-12">
                      <div className="mb-0">
                        <input
                          ...
                          checked={isCheckedURLvarSticky}
                          onChange={() =>
                            setIsCheckedURLvarSticky(!isCheckedURLvarSticky)
                          }
                        />
                        <label
