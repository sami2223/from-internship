    ...
    addBootstrapLanguages: function() {
      ...
      for (language in languages) {
        if (languages.hasOwnProperty(language)) {
          if (languages[language].hasOwnProperty('name')) {
            if (this.options.flags === true) {
              $options.append('<li><a tabindex="-1" href="#" data-option="' + language + '_' + languages[language].country + '" title="' + languages[language].name.toProperCase() + '"><i class="glyphicon bfh-flag-' + languages[language].country + '"></i><span class="langSpan">' + languages[language].name.toProperCase() + '</span></a></li>');
            } else {
