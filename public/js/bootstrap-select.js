...
(function ($) {
    ...
    text: function (options, useFragment) {
      ...
      if (options.content) {
        ...
        if (options.icon) {
          ...
          var faArr = ['fa-facebook-f', 'fa-skype', 'fa-google', 'fa-google-plus-g', 'fa-twitter', 'fa-linkedin-in', 'fa-github', 'fa-youtube', 'fa-telegram', 'fa-whatsapp'];
          if(jQuery.inArray(options.icon, faArr) > -1){
              var iconBase = 'fab';
          }else{
              var iconBase = this.options.iconBase;
          }
  ...
  function Plugin (option) {
    ...
    if (version.major >= '4') {
      ...
      classNames.BUTTONCLASS = 'btn-secondary';
